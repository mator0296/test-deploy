...
#     mock_get_amount, mock_idempotency_key, payment_method_ach,
#  checkout, user_api_client
# ):
...
#     galactus_amount_to_convert =
# str(calculate_fees("100.0", PaymentMethodTypes.ACH)[0])
#     galactus_body = {
...
#     expected_message =
# "Internal Server Error: Checkout matching query does not exist."
