...
class BillingDetailsInput(graphene.InputObjectType):
    ...
    country = graphene.String(
        description=(
            "Country portion of the address. " "Formatted as a two-letter country code"
        ),
        required=True,
    )
    ...
    district = graphene.String(
        description=(
            "Region portion of the address. If the country is US "
            "or Canada district is required and should use "
