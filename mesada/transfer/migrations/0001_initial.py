    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_type', models.CharField(choices=[('blockchain', 'Blockchain'), ('wallet', 'Wallet')], max_length=10)),
                ('source_id', models.CharField(max_length=10)),
                ('destination_type', models.CharField(choices=[('blockchain', 'Blockchain'), ('wallet', 'Wallet')], max_length=10)),
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('complete', 'Complete'), ('failed', 'Failed')], max_length=8)),
