    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exp_month', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(12)])),
                ('exp_year', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(2050)])),
                ...
                ('verification_cvv', django_enumfield.db.fields.EnumField(default=0, enum=mesada.payment.models.verificationCvv)),
                ('verification_avs', django_enumfield.db.fields.EnumField(default=0, enum=mesada.payment.models.verificationAvs)),
